...
class AuthController {
    ...
    static login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield LoginService_1.LoginService.login(email, password, client_1.USER_TYPE.ADMIN);
            if (user === null) {
            ...
            const device = yield DeviceService_1.DeviceService.create(user.id, deviceType, client_1.USER_TYPE.ADMIN, fcmToken !== null && fcmToken !== void 0 ? fcmToken : null, metaData !== null && metaData !== void 0 ? metaData : {});
            return res.json({
                status: true,
